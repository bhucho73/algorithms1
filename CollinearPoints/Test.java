...
public class Test {
    ...
    public Test(Point[] points) {
        ...
        StdOut.println("INPUT SORTED:" + Arrays.toString(sortedPoints));
        ...
        for (int i = 0; i < N; i++) {
            ...
            StdOut.println("pt:" + p.toString());
            Point[] pointsBySlope = sortedPoints.clone();
            Arrays.sort(pointsBySlope, p.slopeOrder());
            StdOut.println("INPUT:" + Arrays.toString(pointsBySlope));
            ...
            while (x < N) {
                ...
                do {
                    StdOut.println("ref slope:" + SLOPE_REF + "slope:" + p.slopeTo(pointsBySlope[x]));
                    candidates.add(pointsBySlope[x++]);
                    StdOut.println("size:" + candidates.size());
                ...
                if (candidates.size() >= 3
                    ...
                    StdOut.println("sorted Coll:" + candidates.toString());
                    Point min = p;
                    Point max = candidates.removeLast();
                    StdOut.println("Lo:" + min + "Hi:" + max);
    ...
    public static void main(String[] args) {
        ...
        Test collinear = new Test(points);
